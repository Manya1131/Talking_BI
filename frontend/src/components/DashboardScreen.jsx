  ...
  const exportPDF = async () => {
    ...
    try {
      ...
      const pageFooter = (pageLabel) => {
        ...
        doc.text("Talking BI  ·  AI-Powered Business Intelligence", PAD, H - 10);
      ...
      doc.text("Talking", PAD + 15, 27);
      doc.setTextColor(232, 96, 44);
      doc.text("BI", PAD + 38, 27);
      ...
      doc.text("Confidential  ·  Generated by Talking BI", PAD, H - 14);
